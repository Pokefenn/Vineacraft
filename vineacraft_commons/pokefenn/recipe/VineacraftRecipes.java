...
public class VineacraftRecipes {
	...
	public static void init() {
	      ...
	      //GameRegistry.addRecipe(new ItemStack(ModItems.vineaBallInfuser), new Object[] { "ivi", "i i", "ivi", ('i'), Block.fenceIron, ('v'), Block.vine});
	       //GameRegistry.addRecipe(new ShapedOreRecipe(ModItems.vineaStick), new Object[] { "vvv", "vsv", "vvv", ('s'), Item.stick, ('v'), Block.vine});
	      ...
	      //BlockShapeless
	       ...
	       //GameRegistry.addRecipe(new ItemStack(ModBlocks.brightVine) new Object[]{} );
